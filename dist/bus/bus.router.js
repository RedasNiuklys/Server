...
// POST: Create
exports.busRouter.post("/", user_router_1.authenticateTokenAdmin, (0, express_validator_1.body)("VIN").isLength({ min: 11, max: 17 }).isString(), (0, express_validator_1.body)("routeId").isInt({ min: 1 }), (0, express_validator_1.body)("Tech_Inspection").isISO8601().toDate(), (0, express_validator_1.body)("Mileage").isInt({ min: 0 }), (0, express_validator_1.body)("StandingSpaces").isInt({ min: 0 }), (0, express_validator_1.body)("SittingSpaces").isInt({ min: 0 }), (0, express_validator_1.body)("WC").isBoolean(), (0, express_validator_1.body)("StartTime").optional().isISO8601().toDate(), (0, express_validator_1.body)("EndTime").optional().isISO8601().toDate(), (0, express_validator_1.body)("Late").optional().isBoolean(), (0, express_validator_1.body)("LateBy").optional().isISO8601().toDate(), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const errors = (0, express_validator_1.validationResult)(req);
    if (!errors.isEmpty()) {
        return res.status(400).json({ errors: errors.array() });
    }
...
// Update PUT
exports.busRouter.put("/:id", user_router_1.authenticateTokenAdmin, (0, express_validator_1.param)("id").isLength({ min: 11, max: 17 }).isString(), (0, express_validator_1.body)("routeId").optional().isInt({ min: 1 }), (0, express_validator_1.body)("Tech_Inspection").optional().isISO8601().toDate(), (0, express_validator_1.body)("Mileage").optional().isInt({ min: 0 }), (0, express_validator_1.body)("StandingSpaces").optional().isInt({ min: 0 }), (0, express_validator_1.body)("SittingSpaces").optional().isInt({ min: 0 }), (0, express_validator_1.body)("WC").optional().isBoolean(), (0, express_validator_1.body)("StartTime").optional().isISO8601().toDate(), (0, express_validator_1.body)("EndTime").optional().isISO8601().toDate(), (0, express_validator_1.body)("Late").optional().isBoolean(), (0, express_validator_1.body)("LateBy").optional().isISO8601().toDate(), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const errors = (0, express_validator_1.validationResult)(req);
    if (!errors.isEmpty()) {
        return res.status(400).json({ errors: errors.array() });
    }
